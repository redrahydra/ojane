<!-- Harsh Verma -->
<!--The fully online banking system made with MySQL DB -->
<!--It uses MySQL remote server to connect to the DB -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link" href="resources/transact.php">Transact</a></li>
          <li><a class="nav-link " href="resources/transactionlog.php">Transaction-log</a></li>
          <li><a class="nav-link " href="resources/accounts.php">Accounts</a></li>
        </ul>
    ...
    <div id="homeCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <a href="resources/transact.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Click_here</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="resources/transactionlog.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Click_here</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          ...
          <a href="resources/accounts.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Details</a>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box" data-aos="zoom-in-left">
              ...
              <h4 class="title"><a href="resources/transact.php">Transact</a></h4>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="100">
              ...
              <h4 class="title"><a href="resources/transactionlog.php">Transaction-log</a></h4>
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-lg-0 ">
            <div class="icon-box" data-aos="zoom-in-left" data-aos-delay="200">
              ...
              <h4 class="title"><a href="resources/accounts.php">Accounts</a></h4>
